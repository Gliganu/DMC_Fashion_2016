...
def makePrediction(classifierUnseenCl, classifierSeenCl, test, customerDict, dropUnseen, dropSeen):
    ...
    # finalSubmitData = DatasetManipulator.filterColumns(finalSubmitData,['orderID','articleID','colorCode','sizeCode','prediction'])
    filemanager.saveDataFrame(testWithPred, "finalSubmit.csv",withIndex=True)
